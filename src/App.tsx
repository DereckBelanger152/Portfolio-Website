...
import { Github, Linkedin, Mail, ExternalLink, Code2, BookOpen, User, ChevronRight, ArrowUp, Menu, X } from 'lucide-react';
              ...
              {navItems.map(item => (
                <button
                  ...
                  className={`block w-full text-left px-4 py-2 ${
                    activeSection === item.id ? 'text-purple-400 bg-purple-900/20' : 'text-gray-300'
                  }`}
                >
                  {item.label}
                </button>
          ...
          <div className="bg-[#12121a] rounded-lg p-8 border border-purple-900/30 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300">
            <div className="max-w-3xl">
              <p className="text-gray-300 leading-relaxed mb-6 hover:text-gray-100 transition-colors">
                ...
                My journey in tech started with simple Python scripts, and now I'm building full-stack 
                applications and exploring the fascinating world of artificial intelligence.
              </p>
              <p className="text-gray-300 leading-relaxed hover:text-gray-100 transition-colors">
                When I'm not coding, you can find me contributing to open-source projects, 
                participating in hackathons, or learning about new technologies. I believe in 
